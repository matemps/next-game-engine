...
void DeviceResources::CreateDeviceResources()
{
...
#ifdef _DEBUG
            OutputDebugStringW(L"WARNING: HDR swap chains not supported");
#endif
        }
    }
...
#ifdef _DEBUG
            OutputDebugStringW(L"INFO: Flip swap effects not supported");
#endif
        }
    }
    ...
    if (FAILED(hr))
    {
        ...
        if (SUCCEEDED(hr))
        {
            OutputDebugStringW(L"Direct3D Adapter - WARP\n");
        }
    }
#endif
